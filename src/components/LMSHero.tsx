...
export function LMSHero() {
  ...
  const scale = useTransform(scrollYProgress, [0, 0.8, 1], [1, 0.9, 0.9]);
  const y = useTransform(scrollYProgress, [0, 0.8, 1], [0, -50, -50]);

  return (
    <div ref={ref} className="relative h-[130vh] z-10">
      <div className="sticky top-0 h-screen flex items-center justify-center pt-20 px-6 sm:px-10 overflow-hidden">
        <motion.div 
